...
// Source: github.com/cloudwan/gohan/extension/goext (interfaces: ICore,ILogger,ISchemas,ISync,IDatabase,ITransaction,IHTTP,IAuth,IUtils,IConfig)
...
func (m *MockIUtils) GetTransaction(arg0 Context) (ITransaction, bool) {
...
func (mr *MockIUtilsMockRecorder) GetTransaction(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransaction", reflect.TypeOf((*MockIUtils)(nil).GetTransaction), arg0)
}

// NewUUID mocks base method
func (m *MockIUtils) NewUUID() string {
...
func (mr *MockIUtilsMockRecorder) NewUUID() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewUUID", reflect.TypeOf((*MockIUtils)(nil).NewUUID))
}
